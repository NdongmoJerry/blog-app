...
<body>
    ...
    <section>
        <h1>Say goodbye to the payment of ticket stress</h1>
    </section>
    <section>
        <p>
            ...
            agency or bus station before paying your tickets again.The below buses are the different models of cars and
    ...
    <div class="image">
        ...
        <div class="column">
            <img src="imagies/ready bus.jpeg" />
            <div class="label">
                First class us
            </div>
        </div>
    ...
    <section class="operation">
        ...
        <p>
            We offer good and reliable services to our customers.Aside that we also offer free servics like
            giving out tckets on promotions at times.We oprates in all the ten regions in cameroon and all the
            ten
            regions have different time schedule to travel that is from departure to your destination
        </p>
    </section>
